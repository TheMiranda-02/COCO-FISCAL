...
import 'dart:convert';
import 'Estilos/diseños_cali_asesor.dart';

class FormComentarioAsesor extends StatefulWidget {
  @override
  _FormComentarioCursoState createState() => _FormComentarioCursoState();
}

class _FormComentarioCursoState extends State<FormComentarioAsesor> {
  ...
  Future<void> _guardarCalificacion() async {
    ...
    try {
      final url = Uri.parse(
        'http://192.168.100.8/api_coco/guardar_calificacion.php', //SEGUN LA CARPETA DEL PHP
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CaliAsesorDesigns.buildAppBar(),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            CaliAsesorDesigns.buildInfoAsesor(
              imagen: 'assets/images/curso_ejemplo.png',
              titulo: 'Nombre del Asesor',
            ...
            CaliAsesorDesigns.buildCalificacionEstrellas(
            ...
            CaliAsesorDesigns.buildCampoComentario(
            ...
            _guardando
                ...
                : CaliAsesorDesigns.buildBotonEnviarImagen(
